...
-- 4) (OPCIONAL) Contas auth de teste E2E — requer service_role/admin (SQL editor tem:
DELETE FROM auth.users
WHERE email LIKE '%@menufacil.local'
  AND raw_user_meta_data->>'name' ILIKE '%e2e%auditoria%';
