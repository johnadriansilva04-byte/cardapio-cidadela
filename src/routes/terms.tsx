    ...
    <div className="min-h-screen bg-black text-gray-100 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-cyan-400">Termos de Uso</h1>
          <button
            onClick={() => navigate({ to: '/' })}
        ...
        <div className="space-y-6 text-sm md:text-base">
          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">1. Aceitação dos Termos</h2>
            <p className="text-gray-300 leading-relaxed">
              Ao utilizar o Cardápio Cidadela, você concorda com estes Termos de Uso. Se não concordar com qualquer parte destes termos, por favor, não utilize nossos serviços.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">2. Descrição do Serviço</h2>
            <p className="text-gray-300 leading-relaxed mb-3">
              O Cardápio Cidadela é uma plataforma que permite:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              ...
              <li>Gerenciar cardápios, categorias e produtos pelo painel</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">3. Responsabilidades do Usuário</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">4. Pedidos e Pagamentos</h2>
            <p className="text-gray-300 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">5. Propriedade Intelectual</h2>
            <p className="text-gray-300 leading-relaxed">
              Todo o conteúdo da plataforma, incluindo textos, imagens, logotipos e software, é protegido por direitos autorais e outras leis de propriedade intelectual. Você não pode copiar, modificar ou distribuir este conteúdo sem permissão.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">6. Limitação de Responsabilidade</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">7. Modificações do Serviço</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">8. Rescisão</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">9. Lei Aplicável</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">10. Contato</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-cyan-400">11. Data de Vigência</h2>
            <p className="text-gray-300 leading-relaxed">
