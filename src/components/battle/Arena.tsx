...
import { ARENA_WIDTH, MAX_HP, type BattleState, type Fighter } from "@/lib/battle/engine";
  ...
  return (
    <div className={side === "right" ? "flex flex-col items-end" : "flex flex-col"}>
      ...
      <div className="mt-0.5 flex items-center gap-1">
        <span className="font-display text-[8px] text-green-900">{Math.round(fighter.hp)} HP</span>
      ...
      <div className="mx-auto w-full max-w-7xl relative h-full flex flex-col pt-4 pb-32">
        ...
        >
          ...
          <div className="absolute top-4 left-1/2 -translate-x-1/2 text-center">
            <div className="text-xs font-bold text-green-700/50 tracking-widest">
          ...
          <div
            ...
            style={{ background: "rgba(34, 139, 34, 0.3)" }}
          />
