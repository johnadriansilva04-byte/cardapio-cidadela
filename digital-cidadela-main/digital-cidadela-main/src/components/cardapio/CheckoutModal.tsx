...
export default function CheckoutModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/80 backdrop-blur sm:items-center">
      <div className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-t-2xl border border-red-500/30 bg-black p-5 sm:rounded-2xl">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={submit}
            className="ember-glow w-full rounded-full bg-red-600 py-3 text-sm font-bold text-white"
          >
