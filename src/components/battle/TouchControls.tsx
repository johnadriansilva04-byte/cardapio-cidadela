...
export function TouchControls({ enabled }: { enabled: boolean }) {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 z-20 flex h-24 bg-black/80 backdrop-blur-sm">
      {/* Lado Esquerdo - Pular */}
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <button
          ...
          className="h-16 w-16 rounded-full border-2 border-red-500/50 bg-red-500/20 text-red-400 backdrop-blur-sm active:scale-95 active:bg-red-500/40 transition-all"
          aria-label="Atirar"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
